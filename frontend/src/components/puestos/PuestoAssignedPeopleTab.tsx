...
export function PuestoAssignedPeopleTab({ employees }: { employees: Employee[] }) {
  if (!employees.length) return <EmptyState text="Todavía no hay personas asignadas a este puesto." />;
