  ...
  return (
    <div className="work-shift-segments-panel">
      <div className="info-note compact">
        <p>Estos tramos son evidencia técnica de cómo se aplicaron los conceptos adicionales; no modifican Hora normal ni el total trabajado. Los tramos sin regla adicional son Hora normal y no requieren revisión.</p>
        {!hasFullConceptData ? (
