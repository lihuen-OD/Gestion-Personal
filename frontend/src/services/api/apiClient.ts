...
const fieldLabels: Record<string, string> = {
  ...
  workRegimeId: "Régimen laboral",
  hourConceptId: "Concepto horario",
  ...
  status: "Estado",
  openShiftOverflowAction: "Acción ante jornada excedida",
  alertOnOutOfShift: "Alerta fuera de turno",
...
const errorMessagesByCode: Record<string, string> = {
  ...
  HOUR_CONCEPT_RULE_NOT_FOUND: "No encontramos la regla horaria solicitada.",
  HOUR_CONCEPT_RULE_INVALID_RANGE: "La hora desde y la hora hasta no pueden ser iguales.",
  WORK_REGIME_UNIQUE_CONSTRAINT: "Ya existe un régimen laboral con ese código.",
  WORK_REGIME_NOT_FOUND: "No encontramos el régimen laboral solicitado.",
  WORK_REGIME_ASSIGNMENT_NOT_FOUND: "No encontramos la asignación de régimen laboral solicitada.",
  WORK_REGIME_ASSIGNMENT_INVALID_RANGE: "La fecha hasta no puede ser anterior a la fecha desde.",
