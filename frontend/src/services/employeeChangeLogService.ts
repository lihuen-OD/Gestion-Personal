...
const fields: FieldConfig[] = [
  ...
  ["company","Empresa","DATOS_LABORALES"],["businessUnit","Unidad de negocio","DATOS_LABORALES"],["establishment","Establecimiento","DATOS_LABORALES"],["costCenter","Centro de costo","DATOS_LABORALES"],["sector","Sector","DATOS_LABORALES"],["position","Puesto","DATOS_LABORALES"],["receiptCategory","Categoría de recibo","DATOS_LABORALES"],["internalCategory","Categoría interna","DATOS_LABORALES"],["agreement","Convenio","DATOS_LABORALES"],["startDate","Fecha de alta / ingreso","DATOS_LABORALES"],["endDate","Fecha de baja / egreso","DATOS_LABORALES"],["exitReason","Motivo de baja / egreso","DATOS_LABORALES"],
  ["directManager","Encargado directo","RESPONSABLES","ASSIGNMENT_CHANGE"],["timeResponsible","Responsable de carga horaria","RESPONSABLES","ASSIGNMENT_CHANGE"],
  ["transport","Utiliza transporte","TRANSPORTE"],["city","Ciudad de origen","TRANSPORTE"],["transportRoute","Recorrido","TRANSPORTE"],["transportNotes","Observaciones transporte","TRANSPORTE"],
  ["enabledHours","Horas habilitadas","CONFIGURACION_HORARIA"],["settlementType","Tipo de liquidación","CONFIGURACION_HORARIA"],["affectsSettlement","Impacta en liquidación","CONFIGURACION_HORARIA"],["exportable","Exportable","CONFIGURACION_HORARIA"],["attendanceBonus","Presentismo","CONFIGURACION_HORARIA"],["award","Premio","CONFIGURACION_HORARIA"],["productiveGoals","Objetivos productivos","CONFIGURACION_HORARIA"],["humanGoals","Objetivos humanos","CONFIGURACION_HORARIA"],["settlementNotes","Observaciones liquidación","CONFIGURACION_HORARIA"],
