...
export function PuestoCreatePage() {
  ...
  return <form onSubmit={save}>
    ...
    <section className="panel"><div className="panel-head"><div><h3>3. Responsabilidades</h3></div></div><PuestoResponsibilitiesTab position={position} setPosition={setPosition} /></section>
    <section className="panel"><div className="panel-head"><div><h3>4. Relaciones internas y externas</h3></div></div><PuestoRelationsTab position={position} setPosition={setPosition} /></section>
    <section className="panel"><div className="panel-head"><div><h3>5. Competencias clave</h3></div></div><PuestoCompetenciesTab position={position} setPosition={setPosition} /></section>
    <section className="panel"><div className="panel-head"><div><h3>6. Condiciones de trabajo</h3></div></div><PuestoWorkConditionsTab position={position} setPosition={setPosition} /></section>
    <section className="panel"><div className="panel-head"><div><h3>7. Indicadores de desempeno</h3></div></div><PuestoIndicatorsTab position={position} setPosition={setPosition} /></section>
    <section className="panel"><div className="panel-head"><div><h3>8. Criterios de evaluacion</h3></div></div><PuestoEvaluationCriteriaTab position={position} setPosition={setPosition} /></section>
