...
export const mockPositions: Position[] = [
  {
    ...
    derivedAreaName: "Administracion Contable",
    derivedSectorName: "Contable",
    ...
    derivedBusinessUnitName: "Administracion Central",
    ...
    salaryCategoryNames: ["Administrativo", "Administrativo A", "Administrativo B", "Administrativo C"],
  ...
  },
  {
    ...
    derivedAreaName: "Direccion",
    derivedSectorName: "Direccion General",
