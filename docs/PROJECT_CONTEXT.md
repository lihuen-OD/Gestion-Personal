...
* **finnegans-export** — exportación de novedades (nunca horas/liquidación) al sistema externo Finnegans; preview vs. definitivo con gate de cierre mensual propio (Etapa 15L.3A).
