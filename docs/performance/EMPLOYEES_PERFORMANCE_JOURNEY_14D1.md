...
|---|---|---|---|---|---|---|---|
| Login (acceso rápido RRHH) | Login | `blank` | 474ms | 3426ms | 4 | 0 | No |
| Entrar a /legajos | A. Listado | `/` | 86ms | 2302ms | 5 | 0 | No |
| Paginación — Siguiente | A. Listado | `/legajos` | 42ms | 125ms | 0 | 0 | No |
| Paginación — Anterior | A. Listado | `/legajos` | 43ms | 126ms | 0 | 0 | No |
| Buscar empleado por texto | A. Listado | `/legajos` | 24ms | 428ms | 0 | 0 | No |
| Limpiar búsqueda | A. Listado | `/legajos` | 15ms | 418ms | 1 | 0 | No |
| Aplicar filtro (Empresa) | A. Listado | `/legajos` | 18ms | 103ms | 0 | 0 | No |
| Limpiar filtro (Empresa) | A. Listado | `/legajos` | 20ms | 104ms | 1 | 0 | No |
| Abrir primer legajo disponible | B. Detalle | `/legajos` | 829ms | 1537ms | 5 | 0 | No |
| Cambiar a pestaña "Información General" | C. Información general | `/legajos/:id` | 29ms | 112ms | 0 | 0 | No |
| Cambiar a pestaña "Contacto y Domicilio" | D. Contacto y domicilio | `/legajos/:id` | 26ms | 109ms | 0 | 0 | No |
| Abrir historial de Domicilio actual | D. Contacto y domicilio | `/legajos/:id` | 1824ms | 1908ms | 2 | 0 | No |
| Cerrar historial de Domicilio actual | D. Contacto y domicilio | `/legajos/:id` | 36ms | 120ms | 0 | 0 | No |
| Abrir edición de Domicilio actual | D. Contacto y domicilio | `/legajos/:id` | 42ms | 125ms | 0 | 0 | No |
| Cambiar a pestaña "Datos Laborales" | E. Datos laborales | `/legajos/:id` | 36ms | 118ms | 0 | 0 | No |
| Abrir historial de Empresa | E. Datos laborales | `/legajos/:id` | 1316ms | 1402ms | 3 | 0 | No |
| Cerrar historial de Empresa | E. Datos laborales | `/legajos/:id` | 22ms | 105ms | 0 | 0 | No |
| Abrir historial de Centro de costo | E. Datos laborales | `/legajos/:id` | 811ms | 894ms | 1 | 0 | No |
| Cerrar historial de Centro de costo | E. Datos laborales | `/legajos/:id` | 21ms | 103ms | 0 | 0 | No |
| Abrir historial de Sector | E. Datos laborales | `/legajos/:id` | 795ms | 879ms | 1 | 0 | No |
| Cerrar historial de Sector | E. Datos laborales | `/legajos/:id` | 31ms | 114ms | 0 | 0 | No |
| Abrir historial de Puesto | E. Datos laborales | `/legajos/:id` | 809ms | 894ms | 1 | 0 | No |
| Cerrar historial de Puesto | E. Datos laborales | `/legajos/:id` | 22ms | 106ms | 0 | 0 | No |
| Abrir historial de Categoría de recibo | E. Datos laborales | `/legajos/:id` | 816ms | 901ms | 1 | 0 | No |
| Cerrar historial de Categoría de recibo | E. Datos laborales | `/legajos/:id` | 21ms | 104ms | 0 | 0 | No |
| Abrir historial de Categoría interna | E. Datos laborales | `/legajos/:id` | 795ms | 878ms | 1 | 0 | No |
| Cerrar historial de Categoría interna | E. Datos laborales | `/legajos/:id` | 28ms | 110ms | 0 | 0 | No |
| Abrir historial de Convenio | E. Datos laborales | `/legajos/:id` | 812ms | 897ms | 1 | 0 | No |
| Cerrar historial de Convenio | E. Datos laborales | `/legajos/:id` | 24ms | 107ms | 0 | 0 | No |
| Abrir historial de Obra Social | E. Datos laborales | `/legajos/:id` | 813ms | 897ms | 1 | 0 | No |
| Cerrar historial de Obra Social | E. Datos laborales | `/legajos/:id` | 22ms | 105ms | 0 | 0 | No |
| Salir de Datos Laborales (a Contacto y Domicilio) | E. Datos laborales | `/legajos/:id` | 46ms | 130ms | 0 | 0 | No |
...
| Cambiar a pestaña "Responsables / Asignaciones" | F. Responsables/Asignaciones | `/legajos/:id` | 29ms | 113ms | 0 | 0 | No |
| Abrir historial de Encargado directo actual | F. Responsables/Asignaciones | `/legajos/:id` | 805ms | 888ms | 2 | 0 | No |
| Cerrar historial de Encargado directo actual | F. Responsables/Asignaciones | `/legajos/:id` | 25ms | 108ms | 0 | 0 | No |
| Abrir historial de Responsable de carga horaria actual | F. Responsables/Asignaciones | `/legajos/:id` | 805ms | 889ms | 2 | 0 | No |
| Cerrar historial de Responsable de carga horaria actual | F. Responsables/Asignaciones | `/legajos/:id` | 25ms | 108ms | 0 | 0 | No |
| Abrir edición de Encargado directo actual | F. Responsables/Asignaciones | `/legajos/:id` | 25ms | 107ms | 0 | 0 | No |
| Abrir edición de Responsable de carga horaria actual | F. Responsables/Asignaciones | `/legajos/:id` | 32ms | 113ms | 0 | 0 | No |
| Cambiar a pestaña "Transporte" | G. Transporte | `/legajos/:id` | 35ms | 118ms | 0 | 0 | No |
| Abrir historial de Transporte actual | G. Transporte | `/legajos/:id` | 1313ms | 1397ms | 2 | 0 | No |
| Cerrar historial de Transporte actual | G. Transporte | `/legajos/:id` | 24ms | 109ms | 0 | 0 | No |
| Abrir edición de Transporte actual | G. Transporte | `/legajos/:id` | 27ms | 110ms | 0 | 0 | No |
| Cambiar a pestaña "Configuración Horaria" | H. Configuración | `/legajos/:id` | 36ms | 119ms | 0 | 0 | No |
| Abrir historial de Conceptos horarios adicionales | H. Configuración | `/legajos/:id` | 1312ms | 1396ms | 3 | 0 | No |
| Cerrar historial de Conceptos horarios adicionales | H. Configuración | `/legajos/:id` | 22ms | 106ms | 0 | 0 | No |
| Abrir edición de Conceptos horarios adicionales | H. Configuración | `/legajos/:id` | 28ms | 109ms | 0 | 0 | No |
| Cambiar a pestaña "Ausentismo / Novedades" | Otras pestañas del legajo (fuera de zonas C-I) | `/legajos/:id` | 38ms | 120ms | 0 | 0 | No |
| Cambiar a pestaña "Gestión Documental" | I. Adjuntos/Documentos | `/legajos/:id` | 32ms | 116ms | 0 | 0 | No |
| Abrir modal 'Agregar documento' (sin subir archivo) | I. Adjuntos/Documentos | `/legajos/:id` | 40ms | 123ms | 0 | 0 | No |
| Cambiar a pestaña "Historial de Eventos" | Otras pestañas del legajo (fuera de zonas C-I) | `/legajos/:id` | 34ms | 115ms | 2 | 0 | No |
| Cambiar a pestaña "Turnos" | Otras pestañas del legajo (fuera de zonas C-I) | `/legajos/:id` | 20ms | 103ms | 2 | 0 | No |
| Cambiar a pestaña "Auditoría" | Otras pestañas del legajo (fuera de zonas C-I) | `/legajos/:id` | 48ms | 132ms | 5 | 0 | No |
| Cambiar a pestaña "Régimen Laboral" | Otras pestañas del legajo (fuera de zonas C-I) | `/legajos/:id` | 24ms | 108ms | 0 | 0 | No |
| Volver al listado | A. Listado | `/legajos/:id` | 76ms | 160ms | 0 | 0 | No |
...
|---|---|---|---|---|
| Login (acceso rápido RRHH) | Login | 474ms | 3426ms | Crítico |
| Entrar a /legajos | A. Listado | 86ms | 2302ms | Lento |
| Abrir historial de Domicilio actual | D. Contacto y domicilio | 1824ms | 1908ms | Medio |
| Abrir primer legajo disponible | B. Detalle | 829ms | 1537ms | Medio |
| Abrir historial de Empresa | E. Datos laborales | 1316ms | 1402ms | Medio |
| Abrir historial de Transporte actual | G. Transporte | 1313ms | 1397ms | Medio |
| Abrir historial de Conceptos horarios adicionales | H. Configuración | 1312ms | 1396ms | Medio |
| Abrir historial de Categoría de recibo | E. Datos laborales | 816ms | 901ms | OK |
| Abrir historial de Convenio | E. Datos laborales | 812ms | 897ms | OK |
| Abrir historial de Obra Social | E. Datos laborales | 813ms | 897ms | OK |

## 8. Top 10 requests más lentas

| Método | Path | Status | Duración |
|---|---|---|---|
| GET | `/api/org-structure` | 200 | 1725ms |
| GET | `/api/documents` | 200 | 1446ms |
| GET | `/api/documents` | 200 | 1444ms |
| GET | `/api/dashboard/metrics` | 200 | 1434ms |
| GET | `/api/document-categories` | 200 | 1421ms |
| GET | `/api/employees/:id/block-history` | 200 | 1401ms |
| GET | `/api/hour-concepts` | 200 | 1194ms |
| GET | `/api/novelties` | 200 | 1149ms |
| GET | `/api/novelties` | 200 | 1149ms |
| GET | `/api/employees/:id/block-history` | 200 | 1081ms |
...
| `GET /api/employees` | 4 |
| `GET /api/workforce/notifications-unread-count` | 3 |
| `GET /api/audit` | 2 |
| `GET /api/novelties` | 2 |
| `GET /api/documents` | 2 |
...
- **Abrir historial de Domicilio actual** (D. Contacto y domicilio) — visible 1824ms, 2 request(s).
- **Cerrar historial de Domicilio actual** (D. Contacto y domicilio) — visible 36ms, 0 request(s).
- **Abrir historial de Empresa** (E. Datos laborales) — visible 1316ms, 3 request(s).
- **Cerrar historial de Empresa** (E. Datos laborales) — visible 22ms, 0 request(s).
- **Abrir historial de Centro de costo** (E. Datos laborales) — visible 811ms, 1 request(s).
- **Cerrar historial de Centro de costo** (E. Datos laborales) — visible 21ms, 0 request(s).
- **Abrir historial de Sector** (E. Datos laborales) — visible 795ms, 1 request(s).
- **Cerrar historial de Sector** (E. Datos laborales) — visible 31ms, 0 request(s).
- **Abrir historial de Puesto** (E. Datos laborales) — visible 809ms, 1 request(s).
- **Cerrar historial de Puesto** (E. Datos laborales) — visible 22ms, 0 request(s).
- **Abrir historial de Categoría de recibo** (E. Datos laborales) — visible 816ms, 1 request(s).
- **Cerrar historial de Categoría de recibo** (E. Datos laborales) — visible 21ms, 0 request(s).
- **Abrir historial de Categoría interna** (E. Datos laborales) — visible 795ms, 1 request(s).
- **Cerrar historial de Categoría interna** (E. Datos laborales) — visible 28ms, 0 request(s).
- **Abrir historial de Convenio** (E. Datos laborales) — visible 812ms, 1 request(s).
- **Cerrar historial de Convenio** (E. Datos laborales) — visible 24ms, 0 request(s).
- **Abrir historial de Obra Social** (E. Datos laborales) — visible 813ms, 1 request(s).
- **Cerrar historial de Obra Social** (E. Datos laborales) — visible 22ms, 0 request(s).
- **Abrir historial de Encargado directo actual** (F. Responsables/Asignaciones) — visible 805ms, 2 request(s).
- **Cerrar historial de Encargado directo actual** (F. Responsables/Asignaciones) — visible 25ms, 0 request(s).
- **Abrir historial de Responsable de carga horaria actual** (F. Responsables/Asignaciones) — visible 805ms, 2 request(s).
- **Cerrar historial de Responsable de carga horaria actual** (F. Responsables/Asignaciones) — visible 25ms, 0 request(s).
- **Abrir historial de Transporte actual** (G. Transporte) — visible 1313ms, 2 request(s).
- **Cerrar historial de Transporte actual** (G. Transporte) — visible 24ms, 0 request(s).
- **Abrir historial de Conceptos horarios adicionales** (H. Configuración) — visible 1312ms, 3 request(s).
...
- Generado: 2026-09-07T13:52:34.263Z
